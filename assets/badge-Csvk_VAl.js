import{eo as R,cZ as I,ea as d,e6 as y,c_ as h,d4 as o,e8 as g,e7 as T,e9 as c,d0 as a,d6 as q,cV as w,ep as N,e5 as f,eq as Q,er as K,es as S,et as B}from"./index-uQq6Bn8p.js";import{C as A,a as M,b as k,d as O,c as H,e as E}from"./card-DnZWGOgt.js";import{f as u,q as m,g as C,u as p,h as F}from"./empty-D0Yb_D3h.js";function _(e){return{mutationFn(i){return R(e,i)},mutationKey:["sendTransaction"]}}function V(e={}){const{mutation:i}=e,s=I(e),t=_(s),{mutate:n,mutateAsync:l,...v}=u({...i,...t});return{...v,sendTransaction:n,sendTransactionAsync:l}}const U=F(`
  query Policy {
    policies {
      id
      flight {
