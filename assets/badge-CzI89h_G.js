import{eo as R,cZ as I,ea as d,e6 as y,c_ as h,d4 as o,e8 as g,e7 as q,e9 as c,d0 as a,d6 as C,cV as T,ep as N,e5 as v,eq as Q,er as K,es as S,et as B}from"./index-ThuMRjPT.js";import{C as A,a as M,b as k,d as O,c as H,e as E}from"./card-DdQXkLkR.js";import{f as u,q as m,g as F,u as p,h as D}from"./empty-D3bLjS_j.js";function _(e){return{mutationFn(s){return R(e,s)},mutationKey:["sendTransaction"]}}function V(e={}){const{mutation:s}=e,i=I(e),t=_(i),{mutate:n,mutateAsync:l,...f}=u({...s,...t});return{...f,sendTransaction:n,sendTransactionAsync:l}}const U=D(`
  query Policy {
    policies {
      id
      flight {
