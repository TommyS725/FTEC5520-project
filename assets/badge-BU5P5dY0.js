import{ep as R,cZ as I,eb as d,e7 as y,c_ as h,d4 as o,e9 as g,e8 as q,ea as c,d0 as a,d7 as C,cV as T,eq as N,e6 as v,er as Q,es as K,et as S,eu as B}from"./index-B0BpL7d4.js";import{C as A,a as M,b as k,d as O,c as H,e as E}from"./card-RcFzZ6VP.js";import{f as u,q as m,g as F,u as p,h as D}from"./empty-CkjccjUt.js";function _(e){return{mutationFn(s){return R(e,s)},mutationKey:["sendTransaction"]}}function V(e={}){const{mutation:s}=e,i=I(e),t=_(i),{mutate:n,mutateAsync:l,...f}=u({...s,...t});return{...f,sendTransaction:n,sendTransactionAsync:l}}const U=D(`
  query Policy {
    policies {
      id
      flight {
